...
async def callback(client, query_callback):
    if query_callback.data == "trdelete":
       ...
       await query_callback.message.edit_text(Translation.CREDITS, reply_markup=InlineKeyboardMarkup( [[ InlineKeyboardButton("MRX🕵️", url="https://t.me/your_daddy_bro") ],[ InlineKeyboardButton("HarshXD🕵️", url="https://t.me/HarshXuBot") ]] ))   
